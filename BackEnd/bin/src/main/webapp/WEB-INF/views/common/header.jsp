				...
				<ul>
					<c:choose>
						<c:when test="${empty userInfo}">
							...
							<li class="login"><a href="/user/regist">회원가입</a></li>
						</c:when>
						<c:otherwise>
							<li><label class="nav-link disabled" style="color: white">${userInfo.userName}님
									반갑습니다.</label></li>
							<li class="logout"><a href="/user/logout"
								id="btn-logout">로그아웃</a></li>
							<li class="logout"><a href="/user/mvinfoprofile">마이페이지</a>
							</li>
						</c:otherwise>
					</c:choose>
					<li><a href="/board/mvlist">일정 공유</a></li>
					<li><a href="/attraction/attraction">여행지 추천</a></li>
					<li><a href="/attraction/facilities">여행지 주변시설</a></li>
				</ul>
