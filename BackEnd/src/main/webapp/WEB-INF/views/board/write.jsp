	...
	<section style="padding-bottom: 0">
		<div class="form" style="max-width: 1500px">
			<div class="container-sm">
				...
				<button type="buttton" class="btn mt-3" id="write"
...
<script>
      ...
      function search(){
    	  ...
    	  fetch("/attraction/search/" + search)
    	  ...
    	  if (checked == false){
    		  ...
    		  if (size >= 4){
        		  ...
        		  <div id="attractioncart${"${contentId}"}" >
        			  <input type="hidden" id="attractionId\${size}" name="attractionId\${size}" value="\${contentId}">
        			  <input type="hidden" id="attractionImg\${size}" name="attractionImg\${size}" value="\${img}">
        					...
        					<div class="row">
        						...
        						<div class="col-10">
        							...
        							<div class="form-floating mt-3">
        								<input type="textarea" class="form-control" id="attractionDesc\${size}" name="attractionDesc\${size}"
      ...
      document.querySelector("#write").addEventListener("click", function(){
    	  ...
    	  if(document.querySelector("#attractionId0") != null)
    	  	attIds.push(document.querySelector("#attractionId0").value);
    	  if(document.querySelector("#attractionId1") != null)
      	  	attIds.push(document.querySelector("#attractionId1").value);
    	  if(document.querySelector("#attractionId2") != null)
      	  	attIds.push(document.querySelector("#attractionId2").value);
    	  if(document.querySelector("#attractionId3") != null)
      	  	attIds.push(document.querySelector("#attractionId3").value);
    	  if(document.querySelector("#attractionDesc0") != null)
      	  	attDescs.push(document.querySelector("#attractionDesc0").value);
    	  if(document.querySelector("#attractionDesc1") != null)
      	  	attDescs.push(document.querySelector("#attractionDesc1").value);
    	  if(document.querySelector("#attractionDesc2") != null)
      	  	attDescs.push(document.querySelector("#attractionDesc2").value);
    	  if(document.querySelector("#attractionDesc3") != null)
      	  	attDescs.push(document.querySelector("#attractionDesc3").value);
